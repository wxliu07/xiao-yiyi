...
​    本项目是我在大二的时候参加了一项校级大创项目, 我们小组的核心目标是基于**光电容积脉搏波描记法(Photoplethysmography，简称PPG)**, 来实现利用手机摄像头进行简易测量心率的效果。
    截止到目前为止, 项目顺利结题, 小组成员完成了基于Android完成了对应的软件开发, 我也完成一款实现简易功能的微信小程序。
